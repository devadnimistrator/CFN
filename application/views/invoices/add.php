  ...
  <div class="col-md-2 col-sm-3 col-xs-12">
    <div class="x_panel">
      ...
      <div class="x_content">
        ...
        $this->invoice_m->form_add_element("date", array('type' => 'date'));
        $this->invoice_m->form_add_element("account_id", array("type" => 'select', 'options' => $accounts, 'onchange' => 'researchPT()'));
        ...
        $this->invoice_m->form_add_element("total_price", array("type" => 'text','readonly' => "readonly"));
        ...
        <table id="table-invoices" class="table table-striped table-bordered" width="100%">
          <thead>
            <tr>
              ...
              <th class="nosort"><?php ___("Account") ?>:</th>
              <th><?php ___("Date") ?>:</th>
...
<script>
    ...
    $(document).ready(function () {
      ...
      setTimeout(function () {
        $tableUsers = $('#table-invoices').DataTable({
          ...
          serverSide: true,
          ajax: {
            url: "<?php echo base_url("invoices/ajax_get_new_pt_data"); ?>",
            type: 'POST',
            data: function (d) {
          ...
          createdRow: function (row, data, index) {
            ...
            document.newInvoice.total_price.value = "$" + Number(parseFloat(totalPrice).toFixed(2)).toLocaleString(3);
          }
        });
      }, 500);
    });
    ...
    function reloadTable(resetPaging) {
      ...
      document.newInvoice.total_price.value = '';
      totalPrice = 0;
